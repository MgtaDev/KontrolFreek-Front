  ...
  <div class="container px-5 py-10 mx-auto">
    <div class="flex flex-wrap w-full mb-20">
      ...
      <h1 className={`text-5xl ${isDarkMode && 'text-white'} text-gray-500 mx-4 mb-4 md:mx-0 text-center md:text-5xl md:text-left`}>Skimo Fans</h1>      
        <div class="h-1 w-full bg-[rgb(95,96,188)]-600 rounded"></div>
      </div>
    ...
    <div class="flex flex-wrap -m-4">
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class={`${isDarkMode && 'bg-gray-200'} bg-gray-100 p-6 rounded-lg`}>
          ...
          <h3 class="tracking-widest text-[rgb(95,96,188)]-500 text-xs font-medium title-font">SUBTITLE</h3>
          ...
          <div class="container px-5 py-10 mx-auto">
            <div class="flex flex-wrap -mx-4 -mb-10 text-center">
              <div class="sm:w-1/2 mb-10 px-4">
                ...
                <button class="flex mx-auto mt-6 text-white bg-[rgb(95,96,188)]-600 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">Button</button>
              </div>
              <div class="sm:w-1/2 mb-10 px-4">
                <div class="rounded-lg h-64 overflow-hidden">
                  <img alt="content" class="object-cover object-center h-full w-full" src={skimo}/>
