        ...
        <nav className='flex justify-between items-center py-4 w-[92%] mx-auto' >
            ...
            <div className={`md:static ${isDarkMode && 'bg-gray-900 text-white'} bg-[rgb(255,255,255)] absolute text-gray-900 md:min-h-fit min-h-[40vh] left-0 ${isMenuOpen ? 'top-[8.2%]' : 'top-[-100%]'} md:w-auto w-full flex items-center px-5`}>
                <ul className='flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-6'>
                    ...
                    <li>
                        <a className='hover:text-pink-500' href='/nosotros'>Nosotros</a>
                    </li>
                    <li>
                        <a className='hover:text-pink-500' href='/productos'>Productos</a>
                    </li>
                    <li>
                        <a className='hover:text-pink-500' href='/comic/showcase'>Comic</a>
                    </li>
                    <li>
            ...
            <div className='flex items-center gap-6'>
                ...
                <div onClick={onToggleMenu} className={`text-3xl ${isDarkMode && 'bg-gray-900 text-white'} bg-[#ffffff] border-2 border-pink-500 pt-2 px-2 rounded-lg cursor-pointer text-pink-500 md:hidden`}>
