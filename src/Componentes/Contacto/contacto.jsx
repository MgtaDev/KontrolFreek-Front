              ...
              <div class="flex flex-wrap -m-2">
                <div class="p-2 w-1/2">
                  <div class="relative">
                    ...
                    <input type="text" id="name" name="name" class={`${isDarkMode && '!bg-white'} w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out`} />
                  </div>
                </div>
                <div class="p-2 w-1/2">
                  <div class="relative">
                    <label for="email" class={`${isDarkMode && '!text-white'} leading-7 text-sm text-gray-600`}>Correo</label>
                    <input type="email" id="email" name="email" class={`${isDarkMode && '!bg-white'}  w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out`} />
                  </div>
                </div>
                <div class="p-2 w-full">
                  <div class="relative">
                    <label for="message" class={`${isDarkMode && '!text-white'} leading-7 text-sm text-gray-600`}>Mensaje</label>
                    <textarea id="message" name="message" class={`${isDarkMode && '!bg-white'} w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out`}></textarea>
                  </div>
                </div>
                <div class="p-2 w-full">
