...
<section class="text-gray-600 body-font relative">
  <div class="container px-5 py-24 mx-auto">
    ...
    <h1 className={`text-5xl ${isDarkMode && 'text-white'} text-gray-500 mx-4 mb-4 md:mx-0 text-center md:text-5xl md:text-left`}>Contactanos</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Tienes otra duda o quieres contactar con soporte? Envianos un correo electronico</p>
    </div>
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-indigo-400">skimo@gmail.com</a>
