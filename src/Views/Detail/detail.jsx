...
const Detail = () => {
  return (
    <div class="bg-gray-100 relative top-20 px-8 pb-12">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <div class="mb-6">
            ...
            <div class="flex space-x-2">
              ...
              <button
                              class="w-8 h-8 bg-pink-500 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"></button>
            </div>
          </div>
          ...
          <div class="flex space-x-4 mb-6">
            <button
                          class="bg-pink-600 flex gap-2 items-center text-white px-6 py-2 rounded-md hover:text-pink-700 hover:bg-white transition duration-600 ease-in-out  hover:border-pink-500 hover:border-2 focus:outline-none focus:ring-2  focus:ring-offset-2">
